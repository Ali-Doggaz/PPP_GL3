	...
	return (
		<div className="h-fit p-5 box-sizing  w-full max-w-[350px]">
			<div className="w-full py-10  bg-neutral-900 rounded-3xl text-white font-sans flex flex-col self-stretch drop-shadow-lg">
				...
				<div
					className={clsx("flex w-full justify-left gap-3 items-center py-5 px-10 cursor-pointer hover:bg-neutral-800 transition-all duration-300", { "border-l border-l-8 border-white": menu.active[0] })}
					onClick={() => {
						menu.clickHandler(0);
					}}
				>
				...
				<div
					className={clsx("flex w-full justify-left gap-3 items-center py-5 px-10 cursor-pointer hover:bg-neutral-800 transition-all duration-300", { "border-l border-l-8 border-white": menu.active[1] })}
					onClick={() => {
						menu.clickHandler(1);
					}}
				>
