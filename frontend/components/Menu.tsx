      ...
      <div className="w-full py-10 bg-pink-900 rounded-3xl text-white font-sans flex flex-col self-stretch drop-shadow-lg">
        ...
        <div
          className={clsx(
            ...
            { "border-l border-l-8 border-white": menu.active[0] }
          )}
          onClick={() => {
            menu.clickHandler(0);
          }}
        >
          ...
          <h1 className="text-base font-normal tracking-widest">
            Manage Account
          </h1>
        </div>
        <div
          className={clsx(
            "flex w-full justify-left gap-3 items-center py-5 px-10 cursor-pointer hover:bg-pink-800 transition-all duration-300",
            { "border-l border-l-8 border-white": menu.active[1] }
          )}
          onClick={() => {
            menu.clickHandler(1);
          }}
        ...
        <div className="w-full mt-20 flex justify-center text-center flex-col">
          <p className="text-sm">
            ...
            <span className="font-semibold text-base">Instify</span>
          </p>
